...
namespace WinterUniverse
{
    public class PawnStats : MonoBehaviour
    {
        ...
        [HideInInspector] public Stat ThermalDamage;
        ...
        [HideInInspector] public Stat ThermalResistance;
        ...
        {
            Stats = new(WorldManager.StaticInstance.ConfigsManager.GetStats());
            AssignStats();
        }
        ...
        public void AssignStats()
        {
            foreach (Stat s in Stats)
            {
                ...
                else if (s.Data.DisplayName == "Thermal Damage")
                {
                    ThermalDamage = s;
                }
                ...
                else if (s.Data.DisplayName == "Thermal Resistance")
                {
                    ThermalResistance = s;
                }
